package fashionable.simba.yanawacortapi.acceptance;
...
import static fashionable.simba.yanawacortapi.acceptance.CourtAcceptanceTemplate.*;
...
public class CourtAcceptanceTest extends AcceptanceTest {
    ...
    void test2() {
        ...
        assertThat(코트_정보_목록_조회(이름_조회, NAME)).contains(응봉공원);
    }
    ...
    void test3() {
        ...
        assertThat(코트_정보_목록_조회(지역_조회, NAME)).contains(성동구);
    }
